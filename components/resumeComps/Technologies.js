    ...
    return (
        <div className="container">
            ...
            <div className="technologies-container">
                ...
                <div className="technologies-point">Java / C# / C++</div>
                <div className="technologies-lvl">
                    <div className="technologies-lvl-in80">-</div>
                </div>


                <div className="technologies-point">Python / PostgreSQL / MySQL</div>
                <div className="technologies-lvl">
                    <div className="technologies-lvl-in75">-</div>
                </div>


                <div className="technologies-point">PHP / Adobe Photoshop</div>
                <div className="technologies-lvl">
                    <div className="technologies-lvl-in75">-</div>
                </div>
